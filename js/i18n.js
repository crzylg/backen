...
const I18N = {
  de: {
    ...
    "ingredients.disclaimer": "Preisquelle: Open Food Facts – Open Prices (kostenlose, von der Community gemeldete Preise aus Deutschland), täglich automatisch synchronisiert. Keine Preise werden erfunden: Wird nichts gefunden, erscheint „Kein Preis gefunden“ und du kannst den Preis manuell eintragen.",
  ...
  uk: {
    ...
    "ingredients.disclaimer": "Джерело цін: Open Food Facts – Open Prices (безкоштовні ціни з Німеччини, надані спільнотою), автоматично оновлюється щодня. Жодні ціни не вигадуються: якщо нічого не знайдено, з'являється «Ціну не знайдено», і ви можете ввести ціну вручну.",
