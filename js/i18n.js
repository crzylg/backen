...
const I18N = {
  de: {
    ...
    "ingredients.defaultSource": "Richtwert",
    "ingredients.enterManually": "manuell eingeben",
    "ingredients.samples": "Datenpunkte",
    "ingredients.total": "Gesamtkosten",
    "ingredients.disclaimer": "Preisquelle: Open Food Facts – Open Prices (kostenlose, von der Community gemeldete Preise aus Deutschland), täglich automatisch synchronisiert. Wo noch keine Live-Daten vorliegen, zeigen wir einen recherchierten Richtwert (Aldi/Lidl-Preisrecherche, Stand siehe Datum) statt „Kein Preis gefunden“. Keine Preise werden erfunden — du kannst jeden Wert jederzeit manuell anpassen.",
    "ingredients.newNamePlaceholder": "Neue Zutat, z. B. Himbeeren",
    "ingredients.addButton": "+ Zutat hinzufügen",
    "ingredients.customBadge": "eigene Zutat",
    "ingredients.searchPrice": "Preis suchen",
    "ingredients.searching": "Suche läuft …",
    "ingredients.liveSource": "Live-Suche",
    "ingredients.deleteIngredient": "Entfernen",
    "ingredients.noProxyConfigured": "Keine Proxy-URL eingestellt (siehe Einstellungen unten).",
    "ingredients.liveNotFound": "Live-Suche: kein Preis gefunden.",
    "ingredients.liveError": "Live-Suche fehlgeschlagen.",
    "settings.title": "Einstellungen: Live-Preissuche für eigene Zutaten",
    "settings.proxyHelp": "Optional: Proxy-URL eintragen, damit „Preis suchen“ bei selbst hinzugefügten Zutaten funktioniert. Einrichtung siehe cloudflare-worker/README.md im Projekt.",
